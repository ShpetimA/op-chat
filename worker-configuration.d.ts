/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: a0789a2675799b6cd9fe372429e4c192)
// Runtime types generated with workerd@1.20250604.0 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		OPENAI_API_KEY: string;
		CONVERSATION_DO: DurableObjectNamespace<import("./src/worker/index").ConversationDO>;
	}
}
